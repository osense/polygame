...
scene::IMesh* GeometryGenerator::createLineMeshZ(f32 size)
{
...
scene::IMesh* GeometryGenerator::createLineMeshX(f32 size)
{
    scene::IAnimatedMesh* mesh = new scene::SAnimatedMesh;
    scene::SMesh* tmpMesh = new scene::SMesh();
    scene::SMeshBuffer* buffer = new scene::SMeshBuffer();
    ...
    buffer->Vertices.push_back(video::S3DVertex(core::vector3df(0, 0, 0), core::vector3df(0, 1, 0), white, null2d));
    buffer->Vertices.push_back(video::S3DVertex(core::vector3df(0, 0, 0), core::vector3df(0, -1, 0), white, null2d));
    buffer->Vertices.push_back(video::S3DVertex(core::vector3df(0, 0, 0), core::vector3df(0, 0, -1), white, null2d));
    buffer->Vertices.push_back(video::S3DVertex(core::vector3df(0, 0, 0), core::vector3df(0, 0, 1), white, null2d));

    buffer->Vertices.push_back(video::S3DVertex(core::vector3df(cs, 0, 0), core::vector3df(0, 1, 0), white, null2d));
    buffer->Vertices.push_back(video::S3DVertex(core::vector3df(cs, 0, 0), core::vector3df(0, -1, 0), white, null2d));
    buffer->Vertices.push_back(video::S3DVertex(core::vector3df(cs, 0, 0), core::vector3df(0, 0, -1), white, null2d));
    buffer->Vertices.push_back(video::S3DVertex(core::vector3df(cs, 0, 0), core::vector3df(0, 0, 1), white, null2d));
...
scene::IMesh* GeometryGenerator::createCubeMesh(f32 size, bool filled)
{
    ...
    if (filled)
    {
        ...
        fillBuffer->Indices.push_back(0);
        fillBuffer->Indices.push_back(4);
        fillBuffer->Indices.push_back(1);
        fillBuffer->Indices.push_back(4);
        fillBuffer->Indices.push_back(5);
        fillBuffer->Indices.push_back(1);
        fillBuffer->Indices.push_back(1);
        fillBuffer->Indices.push_back(5);
        fillBuffer->Indices.push_back(2);
        fillBuffer->Indices.push_back(5);
        fillBuffer->Indices.push_back(6);
        fillBuffer->Indices.push_back(2);
        fillBuffer->Indices.push_back(2);
        fillBuffer->Indices.push_back(3);
        fillBuffer->Indices.push_back(7);
        fillBuffer->Indices.push_back(7);
        fillBuffer->Indices.push_back(6);
        fillBuffer->Indices.push_back(2);
        fillBuffer->Indices.push_back(3);
    ...
    buffer->Indices.push_back(24);
    buffer->Indices.push_back(21);
    buffer->Indices.push_back(25);
    buffer->Indices.push_back(24);
    buffer->Indices.push_back(20);
    buffer->Indices.push_back(24);
    buffer->Indices.push_back(26);
    buffer->Indices.push_back(20);
    buffer->Indices.push_back(26);
    buffer->Indices.push_back(22);
    ...
    buffer->Vertices.push_back(video::S3DVertex(core::vector3df(cs, -cs, -cs), core::vector3df(-1, 1, 0), white, null2d));
    buffer->Indices.push_back(24);
    buffer->Indices.push_back(27);
    buffer->Indices.push_back(28);
    buffer->Indices.push_back(27);
    buffer->Indices.push_back(31);
    buffer->Indices.push_back(28);
    buffer->Indices.push_back(24);
    buffer->Indices.push_back(28);
    buffer->Indices.push_back(30);
    buffer->Indices.push_back(24);
    buffer->Indices.push_back(30);
    buffer->Indices.push_back(26);
    buffer->Indices.push_back(28);
    buffer->Indices.push_back(29);
    buffer->Indices.push_back(16);
    buffer->Indices.push_back(29);
    buffer->Indices.push_back(17);
    buffer->Indices.push_back(16);
...
scene::IMesh* GeometryGenerator::createPyramidMesh(f32 size, bool filled)
{
    ...
    if (filled)
    {
        ...
        fillBuffer->Vertices.push_back(video::S3DVertex(core::vector3df(0, heightHalf, 0), core::vector3df(0, -1, -1), black, null2d));
        fillBuffer->Indices.push_back(6);
        fillBuffer->Indices.push_back(8);
        fillBuffer->Indices.push_back(7);

        fillBuffer->Vertices.push_back(video::S3DVertex(core::vector3df(cs, -heightHalf, -cs), core::vector3df(0, 1, 1), black, null2d));
        fillBuffer->Vertices.push_back(video::S3DVertex(core::vector3df(cs, -heightHalf, cs), core::vector3df(0, 1, -1), black, null2d));
        fillBuffer->Vertices.push_back(video::S3DVertex(core::vector3df(0, heightHalf, 0), core::vector3df(1, -1, 0), black, null2d));
        fillBuffer->Indices.push_back(9);
        fillBuffer->Indices.push_back(11);
        fillBuffer->Indices.push_back(10);
...
scene::IMesh* GeometryGenerator::createTracerMesh(f32 length, f32 height, u32 segments)
{
    ...
    for (u32  i = 1; i <= segments; i++)
    {
        ...
        u32 Idx = i * 2;
        u32 prevIdx = (i-1) * 2;
        buffer->Indices.push_back(prevIdx);
        buffer->Indices.push_back(Idx);
        buffer->Indices.push_back(prevIdx+1);
        buffer->Indices.push_back(Idx);
